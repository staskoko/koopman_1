...
def trainingfcn(eps, lr, batch_size, S_p, T, alpha, W, Num_meas, Num_Obsv, Num_Neurons, train_tensor, test_tensor, M):
  ...
  for i in range(M):
    Model_path.append(f"C:/Users/jokin/Desktop/Uni/Aalborg/Master/Masters_Thesis/Autoencoder_model_params{i}.pth")#(f"/home/trarity/koopman_1/data/Autoencoder_model_params{i}.pth")
